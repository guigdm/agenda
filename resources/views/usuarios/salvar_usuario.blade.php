...
@section('body')
    ...
    <div class="card mb-3">
        <div class="card-header">
            <i class="fa fa-user-plus"></i> Salvar Usuario
        </div>
        <div class="card-body">
                <form class="form-horizontal" role="form" method="post" action="{!! url('/salvarUsuarioNovo') !!}" accept-charset="UTF-8" autocomplete="off">
                    <input type="hidden" name="_token" value="{!! csrf_token() !!}">
                    <div class="form-group">
                        <label class="control-label">Nome*</label>
                        <div>
                            <input type="text" class="form-control" name="nome" maxlength="20" value="{!! old('nome') !!}" placeholder="Nome Completo">
                        </div>
                    </div>
